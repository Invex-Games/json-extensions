    ...
    IWaitForCopilotReview
{
    ...
    static readonly string[] ProjectsToPack = [Projects.Invex_Extensions_Json.Name];
    static readonly string[] ProjectsToTest = [Projects.Invex_Extensions_Json_Tests.Name];
    static readonly string[] ProjectsToTestFx = [Projects.Invex_Extensions_Json_Tests.Name];
